...
``build_serializer`` は渡されたPythonのDict型からシリアライザークラスを作成します。
...
``build_serializer_by_json`` は渡されたjsonで記述された文字列からシリアライザークラスを作成します。
...
``build_serializer_by_json_file`` は渡されたjsonが記述されたファイルからシリアライザークラスを作成します。
...
``build_serializer_by_json`` は渡されたYAMLで記述された文字列からシリアライザークラスを作成します。
...
``build_serializer_by_yaml_file`` は渡されたyamlが記述されたファイルからシリアライザークラスを作成します。
