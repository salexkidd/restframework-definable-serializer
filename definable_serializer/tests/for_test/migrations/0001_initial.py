# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-16 07:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='answer',
            name='paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='for_test.Paper'),
        ),
        migrations.AddField(
            model_name='answer',
            name='respondent',
        ...
        migrations.AlterUniqueTogether(
            name='answer',
            unique_together=set([('paper', 'respondent')]),
        ),
    ]
